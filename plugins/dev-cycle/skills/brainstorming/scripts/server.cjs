...
const DEV_CYCLE_VERSION = readDevCycleVersion();
...
function brandMarkup() {
  const version = escapeHtmlText(DEV_CYCLE_VERSION);
  return '<div class="brand"><span class="brand-copy">Dev Cycle v' + version +
    ' · based on <a href="https://github.com/obra/superpowers">obra/superpowers</a></span></div>';
}
